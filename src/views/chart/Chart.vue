<template>
	<div class="container-view">
		<x-header :left-options="{showBack: false}">分析</x-header>
		<div class="chart-wrap">
			<scroller lock-x height="-118" :scrollbarY="true" @on-scroll="onScroll" ref="chartScrollEvent">
				<div class="chart-con">
...
<script>
	...
	import { Scroller, XHeader, Actionsheet, TransferDom, ButtonTab, ButtonTabItem } from 'vux'
